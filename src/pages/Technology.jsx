...
function Technology() {
  ...
  return (
    ...
    >
      ...
      <p className="block mb-8 sm:hidden font-light text-xl 2xl:text-2xl mulish">Технологийн салбарын гол мэдээнүүд</p>
      {/* Big Banner */}
      {news.length > 0 && (
        (() => {
      ...
      <p className="sm:mb-16 mb-6 hidden sm:block font-light text-xl 2xl:text-2xl mulish">Технологийн салбарын гол мэдээнүүд</p>
