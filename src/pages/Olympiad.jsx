...
function Olympiad() {
  ...
  return (
    ...
    >
      ...
      <p className="block mb-8 sm:hidden font-light text-xl mulish">Салбарын гол олимпиадууд</p>
      {/* Big Banner */}
      {news.length > 0 && (
        (() => {
      ...
      <p className="sm:mb-16 mb-6 hidden sm:block font-light text-xl mulish">Салбарын гол олимпиадууд</p>
